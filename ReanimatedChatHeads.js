...
class Tracking extends Component {
  constructor(props) {
    ...
    this._transY = block([
      cond(
        eq(gestureState, State.ACTIVE),
        [set(transY, add(transY, sub(dragY, prevDragY))), set(prevDragY, dragY)],
        set(prevDragY, 0),
      ),
      transY,
    ]);
      ...
      <View style={styles.container}>
        <Animated.Image
          style={[
            styles.box,
            {
              transform: [{ translateX: this.follow3x, translateY: this.follow3y }],
            },
          ]}
        ...
        <Animated.Image
          style={[
            styles.box,
            {
              transform: [{ translateX: this.follow2x, translateY: this.follow2y }],
            },
          ]}
          source={require('./assets/map.png')}
        />
        ...
        <Animated.Image
          style={[
            styles.box,
            {
              transform: [{ translateX: this.follow1x, translateY: this.follow1y }],
            },
          ]}
          source={require('./assets/map.png')}
        />
...
const ReanimatedChatHeads = () => (
  <View style={styles.container}>
    <Tracking />
  </View>
);

export default ReanimatedChatHeads;
